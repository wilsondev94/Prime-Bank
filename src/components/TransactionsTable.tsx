...
function CategoryBadge({ category }: CategoryBadgeProps) {
  const { textColor, backgroundColor, chipBackgroundColor, borderColor } =
        ...
        {transactions?.map((transaction: Transaction) => {
          ...
          return (
            <TableRow
              key={transaction.id}
              className={`${
                isDebit || amount.at(0) === "-" ? "bg-red-50" : "bg-green-50"
            ...
            >
              ...
              <TableCell className="px-2 max-md:hidden pl-2 pr-10">
